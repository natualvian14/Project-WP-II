...
<body>
    ...
    <ul class="sidenav" id="mobile-nav">
        ...
        <li><a class="btn blue" href="portofolio.php">MASUK</a></li>
    </ul>
    <!-- SideNav-end -->
    <!-- Slider -->
    ...
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h3 class="header center white-text text-lighten-2">PERPUSTAKAAN ONLINE</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/aaa.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
